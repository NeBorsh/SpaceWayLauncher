// Copyright (c) 2019 Space Station 14 Contributors. Licensed under the MIT License.
// Taken from SS14.Launcher. Modified: namespace, and the InvalidOperationException handler below.
...
namespace SpaceWay.Vendor.ZStd;
...
public static class ZStd
{
    ...
    public static void InitZStd()
    {
        ...
        {
            // Modified from the original: inside the loader process the engine has already
            // registered its own native zstd resolver, and .NET allows only one per assembly.
            // The engine's resolver covers the same paths, so this is safe to ignore.
        }
    }
